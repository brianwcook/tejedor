...
func setupTestContainers(t *testing.T) *TestContainerSetup {
	...
	t.Log("Attempting to build and use tejedor-test-pypi from Dockerfile")
	t.Log("Attempting to build and use tejedor from Dockerfile.tejedor")

	// For now, we'll use host networking since containers should be able to communicate via localhost

	// Start private PyPI container using Dockerfile
	...
	// Start tejedor container using Dockerfile
